...
Original file is located at
    https://colab.research.google.com/drive/1njqP_R6ZRIyrzTHzmesuPBnprV1XDqXP
"""
...
def estimate_size(user_choice, user_brand, user_fit, bust_width_cm):
    ...
    ('tops', 'shirts'): {
        'puma': {
            'slim': [(80.0, 84.5, 'XS'), (84.5, 90.5, 'S'), (90.5, 95.5, 'M'), (95.5, 100.5, 'L'), (100.5, 110.5, 'XL')],
            'oversized': [(90.0, 95.5, 'XS'), (95.5, 101.5, 'S'), (101.5, 107.5, 'M'), (111.5, 119.5, 'L'), (119.5, 126.5, 'XL')],
            'regular': [(81.0, 88.5, 'XS'), (90.5, 96.5, 'S'), (96.5, 112.5, 'M'), (111.5, 117.5, 'L'), (117.5, 122.5, 'XL')]
        },
        'nike': {
            'slim': [(80.0, 84.5, 'XS'), (84.5, 90.5, 'S'), (90.5, 95.5, 'M'), (95.5, 100.5, 'L'), (100.5, 110.5, 'XL')],
            'oversized': [(90.0, 95.5, 'XS'), (95.5, 101.5, 'S'), (101.5, 107.5, 'M'), (111.5, 119.5, 'L'), (119.5, 126.5, 'XL')],
    ...
    # Fix: Find the correct key that matches 'tops' or 'shirts'
    for key in size_chart.keys():
        if user_choice in key:
            category_key = key
            break
    else:
        return "Invalid choice"
